...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  8 11:02:47 2018
...
if __name__ == "__main__":
    ...
    xtr, xte, y, word_index = make_df("./train.csv",
                                      "./test.csv",
    ...
    model.fit(xtr, y, batch_size=128, epochs=10, validation_split=0.1, callbacks=[ckpt, early])
    #xtrain, xtest, y_train, y_test = train_test_split(xtr, y, test_size=0.1)
    #model.fit(xtr, y, batch_size=256, epochs=1, validation_split=0.1, verbose=1)
